"use strict";
// This is to keep our code on the rails while we learn JavaScript
...
console.log("Tiffany Hadden");
console.log("Robert Sledge");
console.log("Mitch Hogue");
...
console.log(typeOf("Trolllollolol"));
